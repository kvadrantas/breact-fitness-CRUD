...
function NewRecord({create, showNewRecordModal, setShowNewRecordModal, sportoklubass, setShowWarningModal, error, setError}) {
        ...
        <div className="main-modal" style={{
            ...
            <div className="main-modal-form">
                ...
                <select name="" id="" value={inputs.sportoklubas} onChange={(e) => formControl(e, 'sportoklubas')}>
                    <option value="default" hidden>Select sportoklubas...</option>
